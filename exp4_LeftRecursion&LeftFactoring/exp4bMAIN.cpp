...
-Check for common symbols in the given set of productions by comparing with: A->aB1|aB2
-If found, replace the particular productions with: A->aA’
-A’->B1 | B2|ɛ 5. Display the output
