...
-For each S in SDFA if any s & S is a final state in the NFA then, mark S an a final state in the DFA
-Print the result.
-Stop the program
...
No. of transitions : 2 state name : A
path : 0
